...
@export var ground_alignment_speed: float = 12.0 ## speed at which player aligns to the ground while grounded
...
@export var gravity_increase_max: float = 8.0
@export var gravity_increase_rate: float = 1.0
